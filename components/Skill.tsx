...
const Skill:React.FC<directionProps> = ({ directionLeft, skill }) => {
    return (
        <div className='group relative flex cursor-pointer'>
            ...
            <div className='absolute opacity-0 group-hover:opacity-80 group-hover:bg-white transition duration-300 ease-in-out h-16 w-16 md:w-20 md:h-20 rounded-full'>
