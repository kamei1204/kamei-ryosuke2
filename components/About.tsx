...
const About = () => {
    return (
        <motion.div
            ...
            className='h-screen flex flex-col relative text-center md:text-left md:flex-row max-w-7xl px-10 mr-6 justify-evenly mx-auto items-center'>
            ...
            <div className='relative top-2 space-x-10  md:px-10 md:mt-4'>
